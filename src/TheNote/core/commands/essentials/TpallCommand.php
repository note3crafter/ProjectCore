...
class TpallCommand extends Command
{
    ...
    public function __construct(Main $plugin)
    {
        $this->plugin = $plugin;
        $api = new CoreAPI();
        parent::__construct("tpall", $api->getCommandPrefix("Prefix") . $api->getCommandPrefix("TPallDescription"), "/tpall");
        $this->setPermission(Permissions::$tpall);
    }
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args): bool
    {
        ...
        $sender->sendMessage($api->getCommandPrefix("Prefix") . $api->getLang($sender->getName(),"TPAllSucces"));
        return true;
    }
}